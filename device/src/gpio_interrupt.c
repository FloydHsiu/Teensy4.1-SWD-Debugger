...
// TODO: Use of Fast GPIO6 - GPIO9 probably breaks everything about
// attachInterrupt()
...
FASTRUN static inline __attribute__((always_inline)) void irq_anyport(volatile uint32_t *gpio, voidFuncPtr *table)
{
