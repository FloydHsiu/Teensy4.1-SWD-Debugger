...
__attribute__((used, aligned(1024), section(".vectorsram"))) void (*volatile _VectorsRam[NVIC_NUM_INTERRUPTS + 16])(void);
...
__attribute__((section(".startup"), naked)) void ResetHandler(void)
{
...
__attribute__((section(".startup"), noinline, noreturn)) static void ResetHandler2(void)
{
    unsigned int i;
    __asm__ volatile("dsb" ::: "memory");
#if 0
...
FLASHMEM void configure_external_ram()
{
    ...
    FLEXSPI2_INTEN = 0;
    FLEXSPI2_FLSHA1CR1 = FLEXSPI_FLSHCR1_CSINTERVAL(0) | FLEXSPI_FLSHCR1_TCSH(1) | FLEXSPI_FLSHCR1_TCSS(1);
    ...
    FLEXSPI2_FLSHA2CR1 = FLEXSPI_FLSHCR1_CSINTERVAL(0) | FLEXSPI_FLSHCR1_TCSH(1) | FLEXSPI_FLSHCR1_TCSS(1);
...
__attribute__((naked)) void unused_interrupt_vector(void)
{
    ...
    printf("unused_interrupt_vector\n");
    ...
    CCM_CSCMR1 = (CCM_CSCMR1 & ~CCM_CSCMR1_PERCLK_PODF(0x3F)) | CCM_CSCMR1_PERCLK_CLK_SEL;
    if (F_CPU_ACTUAL > 198000000)
        set_arm_clock(198000000);
    PIT_MCR = 0;
    PIT_TCTRL0 = 0;
...
__attribute__((section(".startup"), noinline)) static void memory_copy(uint32_t *dest, const uint32_t *src, uint32_t *dest_end)
{
#if 0
...
__attribute__((section(".startup"), noinline)) static void memory_clear(uint32_t *dest, uint32_t *dest_end)
{
#if 0
	while (dest < dest_end) {
		*dest++ = 0;
...
__attribute__((weak)) int _read(int file __attribute__((unused)), char *ptr __attribute__((unused)), int len __attribute__((unused)))
{
    return 0;
}

__attribute__((weak)) int _close(int fd __attribute__((unused)))
{
    return -1;
}
...
__attribute__((weak)) int _fstat(int fd __attribute__((unused)), struct stat *st)
{
    st->st_mode = S_IFCHR;
    return 0;
}

__attribute__((weak)) int _isatty(int fd __attribute__((unused)))
{
    return 1;
}

__attribute__((weak)) int _lseek(int fd __attribute__((unused)), long long offset __attribute__((unused)), int whence __attribute__((unused)))
{
    return -1;
}
