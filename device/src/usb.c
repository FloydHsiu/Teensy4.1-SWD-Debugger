...
extern uint8_t usb_compatible_id_desc_buffer[];
extern uint8_t usb_properties_desc_buffer[];
extern const uint8_t usb_config_descriptor_480[];
extern const uint8_t usb_config_descriptor_12[];
extern const uint8_t microsoft_os_properties_desc[];
extern const uint8_t microsoft_os_compatible_id_desc[];
...
static void endpoint0_setup(uint64_t setupdata)
{
    ...
    printf("setup.wRequestAndType=%x, wIndex=%x, value=%x\n", setup.wRequestAndType, setup.wIndex, setup.wValue);
